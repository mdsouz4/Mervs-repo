...
public class BasicStructures{
	...
	public static void main(String[] args){
		...
		if(c>10)
		{
			System.out.println("The sum of the two integers that were added is greater than 10");
		}
		else if(c<10)
		{
		...
		{
			System.out.println("The sum of the two integers that were added is equal to 10");
		}
